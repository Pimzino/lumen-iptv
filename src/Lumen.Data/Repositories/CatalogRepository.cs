...
public sealed class CatalogRepository : ICatalogRepository
{
    ...
    public async Task<IReadOnlyList<Category>> GetCategoriesAsync(
        long profileId, ContentKind kind, CancellationToken cancellationToken)
    {
    ...
    public async Task UpsertChannelsAsync(
    ...
    public async Task<IReadOnlyList<Channel>> GetChannelsAsync(
        long profileId, long? categoryId, CancellationToken cancellationToken)
    {
        var connection = await _connectionFactory.OpenAsync(cancellationToken).ConfigureAwait(false);
        await using (connection.ConfigureAwait(false))
        {
    ...
    public async Task<Channel?> GetChannelAsync(long id, CancellationToken cancellationToken)
    {
        var connection = await _connectionFactory.OpenAsync(cancellationToken).ConfigureAwait(false);
        await using (connection.ConfigureAwait(false))
        {
    ...
    public async Task<int> CountChannelsAsync(long profileId, CancellationToken cancellationToken)
    {
        var connection = await _connectionFactory.OpenAsync(cancellationToken).ConfigureAwait(false);
        await using (connection.ConfigureAwait(false))
        {
    ...
    public async Task UpsertVodItemsAsync(
    ...
    public async Task<IReadOnlyList<VodItem>> GetVodItemsAsync(
        long profileId,
        ContentKind kind,
        long? categoryId,
        VodSortOrder sort,
    ...
    public async Task<VodItem?> GetVodItemAsync(long id, CancellationToken cancellationToken)
    {
        var connection = await _connectionFactory.OpenAsync(cancellationToken).ConfigureAwait(false);
        await using (connection.ConfigureAwait(false))
        {
    ...
    public async Task SetCategoryKindOverrideAsync(
        long categoryId, ContentKind? kind, CancellationToken cancellationToken)
    {
        var connection = await _connectionFactory.OpenAsync(cancellationToken).ConfigureAwait(false);
        await using (connection.ConfigureAwait(false))
        {
